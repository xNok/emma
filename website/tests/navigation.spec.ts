...
test.describe('Navigation', () => {
  ...
  test('should have visible skip to content link for accessibility', async ({ page }) => {
    await page.goto('/');
...
test.describe('Documentation Pages', () => {
  ...
  test('should highlight active page in sidebar', async ({ page }) => {
    ...
    const installationLink = page.locator('aside.sidebar').getByRole('link', { name: 'Installation' });
